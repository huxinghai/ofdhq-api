...
import (
	"log"
	_ "ofdhq-api/app/core/destroy" // 监听程序退出信号，用于资源的释放
	"ofdhq-api/app/global/my_errors"
	"ofdhq-api/app/global/variable"
	"ofdhq-api/app/http/validator/common/register_validator"
	"ofdhq-api/app/service/sys_log_hook"
	"ofdhq-api/app/utils/casbin_v2"
	"ofdhq-api/app/utils/gorm_v2"
	"ofdhq-api/app/utils/snow_flake"
	"ofdhq-api/app/utils/validator_translation"
	"ofdhq-api/app/utils/websocket/core"
	"ofdhq-api/app/utils/yml_config"
	"ofdhq-api/app/utils/zap_factory"
	"os"
)
