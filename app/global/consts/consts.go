...
const (
	...
	// category topic
	CategoryShowTypeInvalidMsg  = "show_type 参数无效, 1/文库，2/社区"
	CategoryShowTypeInvalidCode = -500001
	TopicChoiceInvalidCode      = -500002
	TopicChoiceInvalidMsg       = "choice 无效 1-精选，0：非精选"

	TopicPinTopInvalidCode = -500003
	TopicPinTopInvalidMsg  = "pin_top 无效 1-置顶，0：非置顶"

	TopicGetListErrorMsg  = "查询 topic list 失败"
	TopicGetListErrorCode = -600001
	TopicCreatedErrorMsg  = "创建 topic 失败"
	TopicCreatedErrorCode = -600002
	TopicDeleteErrorCode  = -600003

	TopicGetDetailErrorCode = -600004
	TopicGetDetailErrorMsg  = "查询 topic 详情失败"

	// topic 相关
	TopicCommentCreatedErrorCode = -700001
	TopicCommentCreatedErrorMsg  = "创建评论失败"
	TopicCommentDeleteErrorCode  = -700002
	TopicCommentDeleteErrorMsg   = "删除评论失败"
	TopicCommentListErrorCode    = -700003
	TopicCommentListErrorMsg     = "获取评论失败"
)
